...
Вложения отчётов по задачам сохраняются рядом, также приватно:

```text
storage/app/private/task-reports
```
...
- Включите `storage/app/private/task-reports` в резервную копию сервера.
